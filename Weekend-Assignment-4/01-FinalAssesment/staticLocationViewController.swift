...
class staticLocationViewController: UIViewController {
    ...
    // User Input Text Field for location
    ...
    // Labels for displaying weather and location details of the location with API
    ...
    // This function reverse geo-codes a location address based on latitude and logitude.
